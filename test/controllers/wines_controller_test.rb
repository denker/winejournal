...
class WinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wine" do
    assert_difference('Wine.count') do
      post wines_url, params: { wine: { country: @wine.country, name: @wine.name, region: @wine.region } }
    end
  ...
  test "should update wine" do
    patch wine_url(@wine), params: { wine: { country: @wine.country, name: @wine.name, region: @wine.region } }
